...
public class InitSystemData {
    ...
    @Test
    public void find(){
        UserRoleUtil.buildDoorKeeperByDeptId("20170101",departmentRepository,roleRepository);
        UserRoleUtil.buildHrManagerByDeptId("20170101",departmentRepository,roleRepository);
    }
